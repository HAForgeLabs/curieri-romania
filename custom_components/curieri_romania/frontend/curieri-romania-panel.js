      ...
      <div class="cr-panel">
        <header class="cr-hero">
          <div class="cr-hero-main">
            <div class="cr-logo"><img src="/curieri_romania_static/assets/curieri-romania-logo.png?v=1.0.9" alt="Curieri Romania"></div>
            <div>
            ...
            <a class="cr-hero-badge" href="https://haforgelabs.ro" target="_blank" rel="noopener noreferrer" title="Deschide HAForge Labs"><img src="/curieri_romania_static/assets/haforge-logo.png?v=1.0.9" alt="HAForge Labs"><span>HAForge Labs</span><small>v1.0.9</small></a>
          </div>
    ...
    return `
      <main class="cr-page cr-contact-page">
        ...
        <section class="cr-contact-hero">
          <img src="/curieri_romania_static/assets/haforge-logo.png?v=1.0.9" alt="HAForge Labs">
          <div>
